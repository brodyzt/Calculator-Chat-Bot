...
val bezout: Eval.integer -> Eval.integer -> Eval.integer -> Eval.value
...
val crt: Eval.integer list -> Eval.integer list -> Eval.value

(*[is_square a n] is 1 if x^2 = a (mod n) for some x,
  0 if x^2 != a (mod n) for any x*)
val is_square: Eval.integer -> Eval.integer -> Eval.value
